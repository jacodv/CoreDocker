...
namespace CoreDocker.Api.Components.Projects
{
    public class ProjectSpecification : ObjectGraphType<ProjectModel>
    {
        public ProjectSpecification()
        {
            ...
            Field(d => d.UpdateDate, nullable: true).Description("The last updated date for the project.");
            Field(d => d.CreateDate).Description("The date when the project was created.");
        }
    }
}